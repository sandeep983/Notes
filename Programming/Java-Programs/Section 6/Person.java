...
public class Person {
    ...
    //method to access the firstName field
    public String getFirstName(){
        return this.firstName;
    }

    //method to access the lastName field
    public String getLastName(){
        return this.lastName;
    }

    //method to access the age field
    public int getAge(){
        return this.age;
    }

    //method to set the firstName field
    public void setFirstName(String firstName){
        this.firstName = firstName;
    }

    //method to set the lastName field
    public void setLastName(String lastName){
        this.lastName = lastName;
    }

    //method to set the age field
    ...
    //method to check if the age is between 12 and 20
