#Question
'''
Create a program to cater to the following functionalities
...
add_days = DateUtility.add_dt('12/03/2022', 10)
print(add_days)

sub_days = DateUtility.sub_dt('12/03/2022', 10)
print(sub_days)

get_days = DateUtility.get_days('12/03/2022', '14/04/2022')
print(get_days)

get_days_ex_we = DateUtility.get_days_exclude_we('01/03/2022', '12/03/2022')
print(get_days_ex_we)

get_days_epoch = DateUtility.get_days_since_epoch('12/03/2022')
print(get_days_epoch)

get_bussiness_days = DateUtility.get_business_days('01/12/2021', '31/12/2021')
